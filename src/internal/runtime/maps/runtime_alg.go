...
// hash implementation.
// UseAeshash and aeskeysched are referenced directly from the gd fork's
// runtime·strhash assembly (runtime/asm_amd64.s), hence the push linknames.
//
//go:linkname UseAeshash
var UseAeshash bool
