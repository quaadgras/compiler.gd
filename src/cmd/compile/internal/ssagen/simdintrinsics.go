...
func simdIntrinsics(gd *base.Invocation, addF func(pkg, fn string, b intrinsicBuilder, archFamilies ...sys.ArchFamily)) {
	...
	addF(simdPackage, "Uint32x4.AESRoundKeyGenAssist", opLen1Imm8(gd, ssa.OpAESRoundKeyGenAssistUint32x4, types.TypeVec128, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x4.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.CeilScaled", opLen1Imm8(gd, ssa.OpCeilScaledFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float32x4.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.CeilScaledResidue", opLen1Imm8(gd, ssa.OpCeilScaledResidueFloat64x8, types.TypeVec512, 4), sys.AMD64)
	...
	addF(simdPackage, "Uint8x16.ConcatShiftBytesRight", opLen2Imm8(gd, ssa.OpConcatShiftBytesRightUint8x16, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint8x32.ConcatShiftBytesRightGrouped", opLen2Imm8(gd, ssa.OpConcatShiftBytesRightGroupedUint8x32, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint8x64.ConcatShiftBytesRightGrouped", opLen2Imm8(gd, ssa.OpConcatShiftBytesRightGroupedUint8x64, types.TypeVec512, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x4.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.FloorScaled", opLen1Imm8(gd, ssa.OpFloorScaledFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float32x4.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.FloorScaledResidue", opLen1Imm8(gd, ssa.OpFloorScaledResidueFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Uint8x16.GaloisFieldAffineTransform", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformUint8x16, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint8x32.GaloisFieldAffineTransform", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformUint8x32, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint8x64.GaloisFieldAffineTransform", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformUint8x64, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint8x16.GaloisFieldAffineTransformInverse", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformInverseUint8x16, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint8x32.GaloisFieldAffineTransformInverse", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformInverseUint8x32, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint8x64.GaloisFieldAffineTransformInverse", opLen2Imm8_2I(gd, ssa.OpGaloisFieldAffineTransformInverseUint8x64, types.TypeVec512, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x4.GetElem", opLen1Imm8(gd, ssa.OpGetElemFloat32x4, types.Types[types.TFLOAT32], 0), sys.AMD64)
	addF(simdPackage, "Float64x2.GetElem", opLen1Imm8(gd, ssa.OpGetElemFloat64x2, types.Types[types.TFLOAT64], 0), sys.AMD64)
	addF(simdPackage, "Int8x16.GetElem", opLen1Imm8(gd, ssa.OpGetElemInt8x16, types.Types[types.TINT8], 0), sys.AMD64)
	addF(simdPackage, "Int16x8.GetElem", opLen1Imm8(gd, ssa.OpGetElemInt16x8, types.Types[types.TINT16], 0), sys.AMD64)
	addF(simdPackage, "Int32x4.GetElem", opLen1Imm8(gd, ssa.OpGetElemInt32x4, types.Types[types.TINT32], 0), sys.AMD64)
	addF(simdPackage, "Int64x2.GetElem", opLen1Imm8(gd, ssa.OpGetElemInt64x2, types.Types[types.TINT64], 0), sys.AMD64)
	addF(simdPackage, "Uint8x16.GetElem", opLen1Imm8(gd, ssa.OpGetElemUint8x16, types.Types[types.TUINT8], 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.GetElem", opLen1Imm8(gd, ssa.OpGetElemUint16x8, types.Types[types.TUINT16], 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.GetElem", opLen1Imm8(gd, ssa.OpGetElemUint32x4, types.Types[types.TUINT32], 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.GetElem", opLen1Imm8(gd, ssa.OpGetElemUint64x2, types.Types[types.TUINT64], 0), sys.AMD64)
	...
	addF(simdPackage, "Int32x4.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.RotateAllLeft", opLen1Imm8(gd, ssa.OpRotateAllLeftUint64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.RotateAllRight", opLen1Imm8(gd, ssa.OpRotateAllRightUint64x8, types.TypeVec512, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x4.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.RoundToEvenScaled", opLen1Imm8(gd, ssa.OpRoundToEvenScaledFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float32x4.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.RoundToEvenScaledResidue", opLen1Imm8(gd, ssa.OpRoundToEvenScaledResidueFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Uint32x4.SHA1FourRounds", opLen2Imm8_SHA1RNDS4(gd, ssa.OpSHA1FourRoundsUint32x4, types.TypeVec128, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x8.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairFloat32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Float64x4.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairFloat64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int8x32.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairInt8x32, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int16x16.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairInt16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint8x32.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairUint8x32, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint16x16.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairUint16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.Select128FromPair", opLen2Imm8_II(gd, ssa.OpSelect128FromPairUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Float32x4.SetElem", opLen2Imm8(gd, ssa.OpSetElemFloat32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Float64x2.SetElem", opLen2Imm8(gd, ssa.OpSetElemFloat64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int8x16.SetElem", opLen2Imm8(gd, ssa.OpSetElemInt8x16, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int16x8.SetElem", opLen2Imm8(gd, ssa.OpSetElemInt16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.SetElem", opLen2Imm8(gd, ssa.OpSetElemInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.SetElem", opLen2Imm8(gd, ssa.OpSetElemInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint8x16.SetElem", opLen2Imm8(gd, ssa.OpSetElemUint8x16, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.SetElem", opLen2Imm8(gd, ssa.OpSetElemUint16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.SetElem", opLen2Imm8(gd, ssa.OpSetElemUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.SetElem", opLen2Imm8(gd, ssa.OpSetElemUint64x2, types.TypeVec128, 0), sys.AMD64)
	...
	addF(simdPackage, "Int16x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int16x16.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int16x32.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint16x16.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint16x32.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.ShiftAllLeftConcat", opLen2Imm8(gd, ssa.OpShiftAllLeftConcatUint64x8, types.TypeVec512, 0), sys.AMD64)
	...
	addF(simdPackage, "Int16x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int16x16.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int16x32.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint16x16.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint16x32.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.ShiftAllRightConcat", opLen2Imm8(gd, ssa.OpShiftAllRightConcatUint64x8, types.TypeVec512, 0), sys.AMD64)
	...
	addF(simdPackage, "Float32x4.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.TruncScaled", opLen1Imm8(gd, ssa.OpTruncScaledFloat64x8, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float32x4.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat32x4, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float32x8.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat32x8, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float32x16.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat32x16, types.TypeVec512, 4), sys.AMD64)
	addF(simdPackage, "Float64x2.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat64x2, types.TypeVec128, 4), sys.AMD64)
	addF(simdPackage, "Float64x4.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat64x4, types.TypeVec256, 4), sys.AMD64)
	addF(simdPackage, "Float64x8.TruncScaledResidue", opLen1Imm8(gd, ssa.OpTruncScaledResidueFloat64x8, types.TypeVec512, 4), sys.AMD64)
	...
	addF(simdPackage, "Uint64x2.carrylessMultiply", opLen2Imm8(gd, ssa.OpcarrylessMultiplyUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.carrylessMultiply", opLen2Imm8(gd, ssa.OpcarrylessMultiplyUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.carrylessMultiply", opLen2Imm8(gd, ssa.OpcarrylessMultiplyUint64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Float32x4.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantFloat32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Float64x2.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantFloat64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.concatSelectedConstant", opLen2Imm8(gd, ssa.OpconcatSelectedConstantUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Float32x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedFloat32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Float32x16.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedFloat32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Float64x4.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedFloat64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Float64x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedFloat64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.concatSelectedConstantGrouped", opLen2Imm8(gd, ssa.OpconcatSelectedConstantGroupedUint64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.permuteScalars", opLen1Imm8(gd, ssa.OppermuteScalarsInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.permuteScalars", opLen1Imm8(gd, ssa.OppermuteScalarsUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.permuteScalarsGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsGroupedInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.permuteScalarsGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsGroupedInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.permuteScalarsGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsGroupedUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.permuteScalarsGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsGroupedUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int16x8.permuteScalarsHi", opLen1Imm8(gd, ssa.OppermuteScalarsHiInt16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.permuteScalarsHi", opLen1Imm8(gd, ssa.OppermuteScalarsHiUint16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int16x16.permuteScalarsHiGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsHiGroupedInt16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int16x32.permuteScalarsHiGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsHiGroupedInt16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint16x16.permuteScalarsHiGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsHiGroupedUint16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint16x32.permuteScalarsHiGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsHiGroupedUint16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int16x8.permuteScalarsLo", opLen1Imm8(gd, ssa.OppermuteScalarsLoInt16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint16x8.permuteScalarsLo", opLen1Imm8(gd, ssa.OppermuteScalarsLoUint16x8, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int16x16.permuteScalarsLoGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsLoGroupedInt16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int16x32.permuteScalarsLoGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsLoGroupedInt16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint16x16.permuteScalarsLoGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsLoGroupedUint16x16, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint16x32.permuteScalarsLoGrouped", opLen1Imm8(gd, ssa.OppermuteScalarsLoGroupedUint16x32, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int32x4.tern", opLen3Imm8(gd, ssa.OpternInt32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int32x8.tern", opLen3Imm8(gd, ssa.OpternInt32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int32x16.tern", opLen3Imm8(gd, ssa.OpternInt32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Int64x2.tern", opLen3Imm8(gd, ssa.OpternInt64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Int64x4.tern", opLen3Imm8(gd, ssa.OpternInt64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Int64x8.tern", opLen3Imm8(gd, ssa.OpternInt64x8, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint32x4.tern", opLen3Imm8(gd, ssa.OpternUint32x4, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint32x8.tern", opLen3Imm8(gd, ssa.OpternUint32x8, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint32x16.tern", opLen3Imm8(gd, ssa.OpternUint32x16, types.TypeVec512, 0), sys.AMD64)
	addF(simdPackage, "Uint64x2.tern", opLen3Imm8(gd, ssa.OpternUint64x2, types.TypeVec128, 0), sys.AMD64)
	addF(simdPackage, "Uint64x4.tern", opLen3Imm8(gd, ssa.OpternUint64x4, types.TypeVec256, 0), sys.AMD64)
	addF(simdPackage, "Uint64x8.tern", opLen3Imm8(gd, ssa.OpternUint64x8, types.TypeVec512, 0), sys.AMD64)
