...
func ClosureType(clo *ir.ClosureExpr) *types.Type {
	...
	fields[1] = types.NewField(base.AutogeneratedPos, types.LocalPkg.Lookup("M"), types.Types[types.TUINT64])
	...
	for {
		...
		fields[2+i] = types.NewField(base.AutogeneratedPos, types.LocalPkg.LookupNum("X", i), typ)
		i++
	}
...
func MethodValueType(n *ir.SelectorExpr) *types.Type {
	t := types.NewStruct([]*types.Field{
		...
		types.NewField(base.Pos, Lookup("M"), types.Types[types.TUINT64]),
