...
func TestHTMLWriter(t *testing.T) {
	// Per-invocation state; Ctxt is needed for position rendering.
	gd := &base.Invocation{Ctxt: new(obj.Link)}
	...
	n.op = ONAME
	n.pos = gd.Ctxt.PosTable.XPos(pos)
