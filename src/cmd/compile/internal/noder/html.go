...
func NewHTMLWriter(gd *base.Invocation, pkg *types2.Package, file *syntax.File, info *types2.Info, path string, decl *syntax.FuncDecl, cfgMask string) *HTMLWriter {
	...
	h.Init(gd, out, reportPath, h.DeclHTML)
	h.start()
	return &h
}
